// Componente encargado de desencriptar, leer y verificar la validez de los tokens JWT en el Vehicle Service
...
public class JwtUtil {
    ...
    public boolean esValido(String token) {
        try {
            ...
            log.info("Token validado en Vehicle Service para: {}",
                    claims.getSubject());
            return noExpirado;
        } catch (Exception e) {
            log.warn("Token inválido en Vehicle Service: {}",
                    e.getMessage());
            return false;
        }
    }
