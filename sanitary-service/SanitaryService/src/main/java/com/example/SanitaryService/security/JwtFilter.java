// Filtro que intercepta TODAS las peticiones del Sanitary Service
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (authHeader != null && authHeader.startsWith("Bearer ")) {
            ...
            if (jwtUtil.esValido(token)) {
                ...
                log.info("Token válido en Sanitary Service para: {} rol: {}",
                        email, rol);
                ...
                // El token llegó pero no es válido
                // Puede ser porque expiró o fue manipulado
                log.warn("Token inválido en Sanitary Service para: {}",
