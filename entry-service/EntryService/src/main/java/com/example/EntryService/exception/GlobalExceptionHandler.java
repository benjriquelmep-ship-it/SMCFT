// Intercepta TODAS las excepciones del Entry Service
...
package com.example.EntryService.exception;
...
public class GlobalExceptionHandler {
    ...
    // Maneja los errores de validación del EntryDTO y EntryItemDTO
    ...
    public ResponseEntity<Map<String, String>> manejarValidacion(
        ...
        log.error("Error de validación en Entry Service: {}", errores);
    ...
    public ResponseEntity<Map<String, String>> manejarRuntime(
        ...
        // Registra el error en la consola de IntelliJ
        log.error("Error en Entry Service: {}", ex.getMessage());
