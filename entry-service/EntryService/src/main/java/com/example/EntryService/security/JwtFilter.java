// Filtro que intercepta TODAS las peticiones del Entry Service
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (authHeader != null && authHeader.startsWith("Bearer ")) {
            ...
            if (jwtUtil.esValido(token)) {
                ...
                log.info("Token válido en Entry Service para: {} rol: {}",
                        email, rol);
                ...
                log.warn("Token inválido en Entry Service para: {}",
