...
// Payload   → datos del usuario (email, rol, expiración)
// Signature → firma digital que garantiza que no fue modificado
...
// @Component registra esta clase en Spring para inyectarla donde se necesite
@Component
public class JwtUtil {
    ...
    public boolean esValido(String token) {
        try {
            ...
            // after(new Date()) = la expiración es DESPUÉS de ahora
