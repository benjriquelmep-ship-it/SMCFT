...
@Schema(description = "Estructura de datos obligatoria para el alta, actualización e indexación de usuarios operadores o transportistas en el sistema")
public class UserDTO {
    ...
    @Schema(
            description = "RUN/RUT legal oficial o documento identificatorio del usuario en formato nacional",
            example = "12345678-9",
            maxLength = 12,
    ...
    @Schema(
            description = "Nombre de pila y apellidos completos de la persona natural o funcionario",
            example = "Juan Pérez",
            maxLength = 100,
            requiredMode = Schema.RequiredMode.REQUIRED
    )
    ...
    @Schema(
            description = "Casilla de correo electrónico que actúa como credencial única de acceso (Login Id)",
    ...
    @Schema(
            description = "Contraseña secreta de acceso en texto plano requerida para la creación de credenciales",
    ...
    @Schema(
            description = "Perfil de acceso o rol institucional que determina las barreras de permisos en la arquitectura",
