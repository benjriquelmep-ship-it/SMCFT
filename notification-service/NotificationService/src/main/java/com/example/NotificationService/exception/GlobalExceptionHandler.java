// Intercepta TODAS las excepciones del Notification Service
...
public class GlobalExceptionHandler {
    ...
    // Maneja los errores de validación del NotificationDTO
    ...
    public ResponseEntity<Map<String, String>> manejarValidacion(
        ...
        log.error("Error de validación en Notification Service: {}",
                errores);
    ...
    public ResponseEntity<Map<String, String>> manejarRuntime(
        ...
        // Registra el error en la consola de IntelliJ
        log.error("Error en Notification Service: {}", ex.getMessage());
