// Utilidad JWT del Notification Service
...
public class JwtUtil {
    ...
    public boolean esValido(String token) {
        try {
            ...
            log.info("Token validado en Notification Service para: {}",
                    claims.getSubject());
            ...
            // Si llega aquí es porque el token:
            // → fue manipulado o falsificado
            // → tiene una firma incorrecta
            // → tiene un formato inválido
            log.warn("Token inválido en Notification Service: {}",
                    e.getMessage());
            return false;
        }
    }
