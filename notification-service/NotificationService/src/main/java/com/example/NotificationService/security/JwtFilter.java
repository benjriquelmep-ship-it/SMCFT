// Filtro que intercepta TODAS las peticiones del Notification Service
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (authHeader != null && authHeader.startsWith("Bearer ")) {
            ...
            if (jwtUtil.esValido(token)) {
                ...
                log.info("Token válido en Notification para: {} rol: {}",
                        email, rol);
                ...
                log.warn("Token inválido en Notification para: {}",
