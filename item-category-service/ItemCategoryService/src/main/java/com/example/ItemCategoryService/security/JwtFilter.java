// Filtro que intercepta TODAS las peticiones del Item Category Service
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (authHeader != null && authHeader.startsWith("Bearer ")) {
            ...
            if (jwtUtil.esValido(token)) {
                ...
                log.info("Token válido en Item Category para: {} rol: {}",
                        email, rol);
                ...
                log.warn("Token inválido en Item Category para: {}",
